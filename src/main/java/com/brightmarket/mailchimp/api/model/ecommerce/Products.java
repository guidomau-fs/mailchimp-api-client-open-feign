...
public class Products implements Serializable
{
     ...
     * @param products
     */
    public Products(String storeId, List<Product> products, Long totalItems, List<Link> links) {
        super();
    ...
    public Products withStoreId(String storeId) {
        this.storeId = storeId;
        return this;
    }
    ...
    public Products withTotalItems(Long totalItems) {
        this.totalItems = totalItems;
        return this;
    }
    ...
    public Products withLinks(List<Link> links) {
        this.links = links;
        return this;
    }
