...
public class Order_ implements Serializable
{
    ...
    private Order_.TrackingCode trackingCode;
    /**
    ...
    public Order_ withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public Order_ withCustomer(Customer customer) {
        this.customer = customer;
        return this;
    }
    ...
    public Order_ withCampaignId(String campaignId) {
        this.campaignId = campaignId;
        return this;
    }
    ...
    public Order_ withLandingSite(String landingSite) {
        this.landingSite = landingSite;
        return this;
    }
    ...
    public Order_ withFinancialStatus(String financialStatus) {
        this.financialStatus = financialStatus;
        return this;
    }
    ...
    public Order_ withFulfillmentStatus(String fulfillmentStatus) {
        this.fulfillmentStatus = fulfillmentStatus;
        return this;
    }
    ...
    public Order_ withCurrencyCode(String currencyCode) {
        this.currencyCode = currencyCode;
        return this;
    }
    ...
    public Order_ withOrderTotal(Double orderTotal) {
        this.orderTotal = orderTotal;
        return this;
    }
    ...
    public Order_ withOrderUrl(String orderUrl) {
        this.orderUrl = orderUrl;
        return this;
    }
    ...
    public Order_ withDiscountTotal(Double discountTotal) {
        this.discountTotal = discountTotal;
        return this;
    }
    ...
    public Order_ withTaxTotal(Double taxTotal) {
        this.taxTotal = taxTotal;
        return this;
    }
    ...
    public Order_ withShippingTotal(Double shippingTotal) {
        this.shippingTotal = shippingTotal;
        return this;
    }
     ...
     */
    @JsonProperty("tracking_code")
    public Order_.TrackingCode getTrackingCode() {
        return trackingCode;
    }
     ...
     */
    @JsonProperty("tracking_code")
    public void setTrackingCode(Order_.TrackingCode trackingCode) {
        this.trackingCode = trackingCode;
    }

    public Order_ withTrackingCode(Order_.TrackingCode trackingCode) {
        this.trackingCode = trackingCode;
        return this;
    }
    ...
    public Order_ withProcessedAtForeign(Date processedAtForeign) {
        this.processedAtForeign = processedAtForeign;
        return this;
    }
    ...
    public Order_ withCancelledAtForeign(Date cancelledAtForeign) {
        this.cancelledAtForeign = cancelledAtForeign;
        return this;
    }
    ...
    public Order_ withUpdatedAtForeign(Date updatedAtForeign) {
        this.updatedAtForeign = updatedAtForeign;
        return this;
    }
    ...
    public Order_ withShippingAddress(ShippingAddress shippingAddress) {
        this.shippingAddress = shippingAddress;
        return this;
    }
    ...
    public Order_ withBillingAddress(BillingAddress billingAddress) {
        this.billingAddress = billingAddress;
        return this;
    }
    ...
    public Order_ withPromos(List<Promo> promos) {
        this.promos = promos;
        return this;
    }
    ...
    public Order_ withLines(List<Line> lines) {
        this.lines = lines;
        return this;
    }
    ...
    public Order_ withOutreach(Outreach outreach) {
        this.outreach = outreach;
        return this;
    }
    ...
    public Order_ withLinks(List<Link> links) {
        this.links = links;
        return this;
    }
    ...
    public Order_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public enum TrackingCode {
        ...
        private final static Map<String, Order_.TrackingCode> CONSTANTS = new HashMap<String, Order_.TrackingCode>();

        static {
            for (Order_.TrackingCode c: values()) {
        ...
        @JsonCreator
        public static Order_.TrackingCode fromValue(String value) {
            Order_.TrackingCode constant = CONSTANTS.get(value);
            if (constant == null) {
